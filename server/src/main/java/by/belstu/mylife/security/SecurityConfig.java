package by.belstu.mylife.security;

import by.belstu.mylife.services.CustomUserDetailsService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .and()
                .authorizeRequests()
                .antMatchers(SecurityConstants.SIGN_UP_URLS, SecurityConstants.API_DOCKS, SecurityConstants.SWAGGER).permitAll()
