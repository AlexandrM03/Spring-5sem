...
import by.belstu.mylife.facade.PostFacade;
import by.belstu.mylife.payload.response.MessageResponse;
import by.belstu.mylife.services.PostService;
...
public class PostController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Object> createPost(@Valid @RequestBody PostDTO postDTO, BindingResult result, Principal principal) {
